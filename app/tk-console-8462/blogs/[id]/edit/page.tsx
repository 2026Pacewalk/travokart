    ...
    <AdminShell
      ...
      actions={
        <div className="flex items-center gap-3">
          ...
          <Link href="/tk-console-8462/blogs" className="text-[13px] font-semibold text-[color:var(--muted)] inline-flex items-center gap-1"><ArrowRight width={14} height={14} className="rotate-180" /> Back</Link>
        </div>
      }
    >
